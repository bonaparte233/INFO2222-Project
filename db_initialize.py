...
con.execute("CREATE TABLE Users (username VARCHAR(200) PRIMARY KEY, password VARCHAR(200), admin CHAR(1), salt VARCHAR(200))")
con.execute("INSERT INTO Users (username, password, admin, salt) VALUES ('WentaoGao', '123456', '1', 'xyz')")
con.execute("INSERT INTO Users (username, password, admin, salt) VALUES ('James', '123456', '1', 'xyz')")
con.commit()
